        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                    <form class="form-sample" method="post" action="Historial">
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                              <input type="number" class="form-control" name="talla" placeholder="Estatura">
                          </div>
                        </div>
                      </div>
                    </div>
                        <button type="reset" class="btn btn-gradient-light btn-rounded btn-fw">Restablecer</button>
                        <button class="btn btn-gradient-success btn-rounded btn-fw">Actualizar</button>
